...
function Walls:load()
    ...
    self.layouts[13]=function(_room)
    ...
    self.layouts[14]=function(_room)
    ...
    self.layouts[15]=function(_room)
        ...
        self:newWall(_room.xPos+256,16+_room.yPos+28,'vertical',100)
    end
    self.layouts[16]=function(_room)
        self:newWall(_room.xPos+272,16+_room.yPos+92,'horizontal',80)
        self:newWall(_room.xPos+32,16+_room.yPos+236,'horizontal',144)
        self:newWall(_room.xPos+256,16+_room.yPos+236,'horizontal',96)
        self:newWall(_room.xPos+123,16+_room.yPos+28,'vertical',100)
    end
    ...
    self.layouts[17]=function(_room)
        ...
        self:newWall(_room.xPos+255,16+_room.yPos+28,'vertical',100)
        self:newWall(_room.xPos+124,16+_room.yPos+220,'vertical',100)
    end
    self.layouts[18]=function(_room)
        self:newWall(_room.xPos+128,16+_room.yPos+108,'horizontal',128)
        self:newWall(_room.xPos+128,16+_room.yPos+220,'horizontal',128)
        self:newWall(_room.xPos+124,16+_room.yPos+28,'vertical',100)
    ...
    self.layouts[21]=function(_room)
        ...
        self:newWall(_room.xPos+108,16+_room.yPos+28,'vertical',100)
    ...
    self.layouts[22]=function(_room)
        ...
        self:newWall(_room.xPos+112,16+_room.yPos+108,'horizontal',160)
        self:newWall(_room.xPos+271,16+_room.yPos+28,'vertical',100)
    ...
    self.layouts[27]=function(_room)
        ...
        self:newWall(_room.xPos+140,16+_room.yPos+92,'vertical',164)
        self:newWall(_room.xPos+255,16+_room.yPos+28,'vertical',148)
    end
    self.layouts[28]=function(_room)
        ...
        self:newWall(_room.xPos+239,16+_room.yPos+92,'vertical',164)
        self:newWall(_room.xPos+124,16+_room.yPos+28,'vertical',148)
    end
    ...
    self.layouts[37]=function(_room)
        ...
        self:newWall(_room.xPos+268,16+_room.yPos+28,'vertical',84)
    ...
    self.layouts[38]=function(_room)
        self:newWall(_room.xPos+32,16+_room.yPos+224,'horizontal',80)
        self:newWall(_room.xPos+272,16+_room.yPos+80,'horizontal',80)
        self:newWall(_room.xPos+268,16+_room.yPos+80,'vertical',116)
        self:newWall(_room.xPos+111,16+_room.yPos+16,'vertical',84)
        self:newWall(_room.xPos+111,16+_room.yPos+160,'vertical',84)
        self:newWall(_room.xPos+268,16+_room.yPos+240,'vertical',52)
    end
    self.layouts[39]=function(_room)
        ...
        self:newWall(_room.xPos+268,16+_room.yPos+28,'vertical',52)
    end
    self.layouts[40]=function(_room)
        ...
        self:newWall(_room.xPos+111,16+_room.yPos+28,'vertical',52)
    end
    self.layouts[41]=function(_room)
        ...
        self:newWall(_room.xPos+108,16+_room.yPos+28,'vertical',84)
    ...
    self.layouts[42]=function(_room)
        ...
        self:newWall(_room.xPos+271,16+_room.yPos+28,'vertical',84)
    ...
    self.layouts[43]=function(_room)
        ...
        self:newWall(_room.xPos+92,16+_room.yPos+28,'vertical',84)

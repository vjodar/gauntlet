...
function ResourceNodes:add_tree(_x,_y) 
    ...
    function node:load() 
        ...
        self.collider=world:newRectangleCollider(_x,_y,14,26)
...
function ResourceNodes:add_rock(_x,_y) 
    ...
    function node:load() 
        --setup collider and position vectors
        self.xPos, self.yPos = _x,_y 
        self.collider=world:newRectangleCollider(_x,_y,16,13)
        self.collider:setType('static')
...
function ResourceNodes:add_vine(_x,_y) 
    ...
    function node:load() 
        --setup collider and position vectors
        self.xPos, self.yPos = _x,_y 
        self.collider=world:newRectangleCollider(_x,_y,16,31)
        self.collider:setType('static')
...
function ResourceNodes:add_fungi(_x,_y) 
    ...
    function node:load() 
        --setup collider and position vectors
        self.xPos, self.yPos = _x,_y 
        self.collider=world:newRectangleCollider(_x,_y,16,15)
        self.collider:setType('static')
...
function ResourceNodes:add_fishing_hole(_x,_y) 
    ...
    function node:load() 
        --setup collider and position vectors
        self.xPos, self.yPos = _x,_y 
        self.collider=world:newRectangleCollider(_x,_y,16,16)
        self.collider:setType('static')
    ...
    function node:draw() 
        self.currentAnim:draw(self.spriteSheet,self.xPos,self.yPos,nil,1,1,0,0)
    end
